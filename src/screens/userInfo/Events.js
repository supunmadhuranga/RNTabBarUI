    ...
    render() {
        return (
            <ScrollView showsVerticalScrollIndicator={false} style={[{ flex:1, backgroundColor: '' }]}>
                ...
                <View style={{flexDirection:'row', flexWrap: 'wrap', marginLeft:Sizes.wp('3%'), marginRight:Sizes.wp('3%'), marginTop:Sizes.wp('4%'), marginBottom:Sizes.wp('4%'), justifyContent:'space-between'}}>
